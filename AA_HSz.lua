...
--#endregion
    ...
    local DiscordLib = loadstring(game:HttpGet "https://raw.githubusercontent.com/NoNiName/Library/main/Discord_UiLib")()
    ...
    local youtubesserver = win:Server("Youtube & Discord         ", "http://www.roblox.com/asset/?id=11754490336")
