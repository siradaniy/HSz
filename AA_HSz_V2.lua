	...
	pcall(function()
		...
		local data = {
			...
			["embeds"] = {
				{
					["author"] = {
						["name"] = "Current Special Banner | แจ้งเตือน ✔",
						["icon_url"] = "https://cdn.discordapp.com/emojis/997123585476927558.webp?size=96&quality=lossless"
					},
					["thumbnail"] = {
						['url'] = thumbnails_avatar.data[1].imageUrl,
	...
	pcall(function()
		...
		local data = {
			...
			["embeds"] = {
				{
					["author"] = {
						["name"] = "Current Standard Banner | แจ้งเตือน ✔",
						["icon_url"] = "https://cdn.discordapp.com/emojis/997123585476927558.webp?size=96&quality=lossless"
					},
					["thumbnail"] = {
						['url'] = thumbnails_avatar.data[1].imageUrl,
...
function MainModule()
    ...
    ayfieldLib = RayfieldLibrary

    mainWindow = RayfieldLibrary:CreateWindow({
        Name = "Anime Adventures " .. scriptVersion .. " - " .. exec .. " (HSz Member Only: " .. tostring(getgenv().isAlt) .. ")",
