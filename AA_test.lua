...
--#region Select world tab
        ...
        "Ghoul City", "Hollow World", "Ant Kingdom", "Magic Town", "Cursed Academy","Clover Kingdom", "Clover Legend - HARD","Hollow Legend - HARD","Cape Canaveral","JoJo Legend - HARD",
        "Aline Spaceship"}, getgenv().world, function(world)
            getgenv().world = world
            updatejson()
            ...
            elseif world =="Aline Spaceship" then
                getgenv().leveldrop:Clear()
                table.clear(levels)
                ...
                function(input, gameProcessed)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        elseif game.Workspace._map:FindFirstChild("boros_ship") then
                            ...
                            SpawnUnitPos["OP"][UnitPos]["x"] = a.Position.X
                            SpawnUnitPos["OP"][UnitPos]["y"] = a.Position.Y
                            SpawnUnitPos["OP"][UnitPos]["z"] = a.Position.Z
                        end
           ...
           jojo = {
            ...
            UP1  = {
              ...
              UP3  = {
                x = -304.1457824707031, 
                y = 364.21185302734375, 
                z = 1436.0750732421875
             },
              UP2  = {
                x = -280.52178955078125, 
                y = 364.21185302734375, 
                z = 1442.6151123046875
             },
              UP6  = {
                x = -261.36993408203125, 
                y = 364.2118225097656, 
                z = 1421.857421875
             },
              UP5  = {
                x = -254.68722534179688, 
                y = 364.21185302734375, 
                z = 1382.4862060546875               
             },
              UP4  = {
                x = -282.77978515625, 
                y = 364.21185302734375, 
                z = 1367.6402587890625
             }	 
           }
            ...
            if game.PlaceId ~= 8304191830 then
                ...
                elseif game.Workspace._map:FindFirstChild("boros_ship") then
                    ...
                    for i = 1, 6 do
                        ...
                        if unitinfo ~= nil then
                            local unitinfo_ = unitinfo:split(" #")
                            local pos = getgenv().SpawnUnitPos["OP"]["UP" .. i]
