...
loadstring(game:HttpGet("https://raw.githubusercontent.com/siradaniy/HSz/main/CloneRef.lua", true))()

-- Dex Bypasses
loadstring(game:HttpGet("https://raw.githubusercontent.com/siradaniy/HSz/main/Bypasses.lua", true))()
