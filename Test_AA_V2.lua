...
local SelectUnits = Farm:Sector("เลือก Unit")
local SelectWorld = Farm:Sector("เลือก World")
local UnitPosition = Farm:Sector("เลือกจุดวาง Unit")
local MoreFarmConfig = Farm:Sector("ตั้งค่า Farming เพิ่มเติม")
local AutoFarmConfig = Farm:Sector("ตั้งค่า Auto Farm ")
...
function setGlobalValues()
    ...
    getgenv().AutoReplay = config.AutoReplay
    getgenv().AutoNext = config.AutoNext
...
function sex()
    ...
    local function UnitSec()
        ...
        SelectUnits:Cheat("Button", "เลือก Units ที่ใส่อยู่", function() --Selects Currently Equipped Units!
        ...
        local a = SelectUnits:Cheat("Dropdown", "ทีม Units",function(preset)
    ...
    local function WorldSec()
        ...
        SelectWorld:Cheat("Checkbox","ปิดห้อง Friends Only  ", function(bool)
            print(bool)
    ...
    local function UnitPosSec()
        UnitPosition:Cheat("Button", "เลือกจุดวาง Unit 1", function()
            MouseClick2("UP1")
        end)
        UnitPosition:Cheat("Button", "เลือกจุดวาง Unit 2", function()
            MouseClick2("UP2")
        end)
        UnitPosition:Cheat("Button", "เลือกจุดวาง Unit 3", function()
            MouseClick2("UP3")
        end)
        UnitPosition:Cheat("Button", "เลือกจุดวาง Unit 4", function()
            MouseClick2("UP4")
        end)
        UnitPosition:Cheat("Button", "เลือกจุดวาง Unit 5", function()
            MouseClick2("UP5")
        end)
        UnitPosition:Cheat("Button", "เลือกจุดวาง Unit 6", function()
            MouseClick2("UP6")
        end)
    end
    ...
    local function unitconfig()
        ...
        --//UNIT 1
        Unit1:Cheat("Textbox", "wave ที่วาง", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit1:Cheat("Textbox", "wave ที่อัปตัว", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit1:Cheat("Textbox", "จำนวนขั้นที่อัพ", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999})

        Unit1:Cheat("Textbox", "ขาย เมื่อถึง wave", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999}) 


        --//UNIT 2
        Unit2:Cheat("Textbox", "wave ที่วาง", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit2:Cheat("Textbox", "wave ที่อัปตัว", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit2:Cheat("Textbox", "จำนวนขั้นที่อัพ", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})
        Unit2:Cheat("Textbox", "ขาย เมื่อถึง wave", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999}) 
        
        --//UNIT 3
        Unit3:Cheat("Textbox", "wave ที่วาง", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit3:Cheat("Textbox", "wave ที่อัปตัว", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit3:Cheat("Textbox", "จำนวนขั้นที่อัพ", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})
        Unit3:Cheat("Textbox", "ขาย เมื่อถึง wave", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999}) 

        --//UNIT 4
        Unit4:Cheat("Textbox", "wave ที่วาง", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit4:Cheat("Textbox", "wave ที่อัปตัว", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit4:Cheat("Textbox", "จำนวนขั้นที่อัพ", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})
        Unit4:Cheat("Textbox", "ขาย เมื่อถึง wave", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999}) 
        
         --//UNIT 5
         Unit5:Cheat("Textbox", "wave ที่วาง", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit5:Cheat("Textbox", "wave ที่อัปตัว", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit5:Cheat("Textbox", "จำนวนขั้นที่อัพ", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})
        Unit5:Cheat("Textbox", "ขาย เมื่อถึง wave", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999}) 

        --//UNIT 6
        Unit6:Cheat("Textbox", "wave ที่วาง", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit6:Cheat("Textbox", "wave ที่อัปตัว", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})

        Unit6:Cheat("Textbox", "จำนวนขั้นที่อัพ", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 0})
        Unit6:Cheat("Textbox", "ขาย เมื่อถึง wave", function(Value)
            Value = tonumber(Value)
        end, {placeholder = 999}) 
    end
    ...
    if game.PlaceId == 8304191830 then
        UnitPosition:Cheat("Label","ไม่สามารถใช้ได้ใน game Lobby!")    
        UnitSec()
        WorldSec()
        AutoFarmSec()
        MoreFarmSec()
        ...
        SelectUnits:Cheat("Label","สามารถใช้ได้เฉพาะใน game Lobby!")    
        WorldSec()
        AutoFarmSec()
        MoreFarmSec()
        ChallengeSec()
